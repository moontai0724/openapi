...
import { transformResponses, type TransformResponsesOptions } from "..";
...
const options: TransformResponsesOptions = {
  responseOptions: {
...
it("should be able to transform a schema and overwrite properties with options", () => {
  expect(transformResponses(schema, options)).toEqual(expected);
});
